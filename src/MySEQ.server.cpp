	...
	_In_ int nCmdShow)
{
	...
	if (argc > 1 && (!console_mode && !debug_mode && !services && !otherini))
	{
		...
		cout << "      console - run server as a console" << endl
			 << endl;
		cout << "      -f   - Load alternate Ini FileName" << endl
			 << endl;
		cout << "      -i   - Install server.exe as a service" << endl
			 << endl;
		cout << "      -d   - Removed MySEQ server.exe which was installed as service." << endl
			 << endl;
	...
	else if (!services)
	{
		cout << "========================" << endl
			 ...
			 << "Copyright MySEQ Project 2003-2013" << endl
			 << endl;
	}
